...
Feature: Board
  ...
  Scenario: User puts the house at empty cell
    Given Game board with default preset houses boards/give/simple_board/positive/default.yml
    Given User have in board queue [1,1,1,1]
    When User place on [3,1]
    Then A new boards/then/simple_board/positive/result_board.yml should  be generated by user as a result of the installation of the house at empty cell

  @positive
  Scenario: User puts the house at used cell
    Given Game board with default preset houses boards/give/simple_board/negative/default.yml
    Given User have in board queue [1,1,1,1]
