...
@scenario('board.feature', 'Checking the end of the game after the entire game board is full')
def test_board_3():
    pass
...
@given("Fully filled board with houses of different levels", target_fixture="full_board")
def full_board():
    return [
        [1, 2, 10, 9, 1, 5],
        [2, 3, 9, 10, 2, 1],
