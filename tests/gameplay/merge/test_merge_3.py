...
@given(parsers.cfparse('Game board with default preset houses {file:String}', extra_types=EXTRA_TYPES),
...
@then(parsers.cfparse('User have in board queue {data:List}', extra_types=EXTRA_TYPES),
...
@when(parsers.cfparse('User place on {file:String}', extra_types=EXTRA_TYPES), target_fixture="change_board")
